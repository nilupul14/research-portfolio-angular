...
export class ResearcherService {
  ...
  getResearcher(id: number) : Observable<Object>{
    return this.http.get(`${this.baseUrl}/researcher/${id}`);
  }
  ...
  updateResearcher(id: number, value: any): Observable<Object>{
    return this.http.put(`${this.baseUrl}/researcherUpdate/${id}`, value);
  }
